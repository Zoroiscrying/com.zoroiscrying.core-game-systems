...
1. Make an [Issue](https://github.com/zoroiscrying/core-game-systems/issues/new)
...
```json
    {
        "dependencies": {
            "com.zoroiscrying.core-game-systems": "https://github.com/YOUR_USER/core-game-systems.git"
        }
    }
```
...
reported to the community leaders responsible for enforcement at zoroiscrying@outlook.com.
